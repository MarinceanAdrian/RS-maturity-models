...
export var roStrings = {
    //survey templates
    templates:{
      template_all_categories: "Toate categoriile",
      template_evenimente: "Evenimente",
      template_restaurant: "Restaurant",
      template_resurse_umane: "Resurse umane"
    },
    survey: {
      edit: "Editeaza",
      ...
      copy: "Copy",
      duplicate: "Multiplică elementul", // Duplicate
      settings: "Settings",
    ...
    ed: {
      ...
      modified: "Modificare efectuată.", // Modified
      saving: "Se salvează", // Saving
      saved: "Salvat", // Saved
      ...
      italic: "Italic",
      underline: "Underline",
      addNewQuestion: "ADAUGA INTREBARE",
      selectPage: "Select page...",
      htmlPlaceHolder: "HTML content will be here.",
      panelPlaceHolder: "Drop a question from the toolbox here.",
      surveyPlaceHolder: `Chestionarul dumneavoastră este gol.\n
                          Fie folosiți opțiunea drag and drop pentru a aduce elementele din ecranul din stânga în pagina principală, \n
                          fie acționați butonul ADAUGĂ ÎNTREBARE.`, // The survey is empty. Drag an element from the toolbox or click the button below.
    ...
    pe: {
      ...
      visible: "Visible",
      isRequired: "Marchează ca obligatoriu", // Required
